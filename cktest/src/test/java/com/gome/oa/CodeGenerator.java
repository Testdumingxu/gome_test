...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/cktest/src/main/java");
        gc.setAuthor("dmx"); // 类注释 作者名
        gc.setOpen(false);
        gc.setFileOverride(true); // 为true时，生成类重复的会被覆盖
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "cktest/src/main/resources/mapper/"
        ...
        strategy.setInclude("user","test_rule","test_report","suite","project",
                "cases","case_param_value","api_request_param","api_classifcation","api"); //需要生成的表
